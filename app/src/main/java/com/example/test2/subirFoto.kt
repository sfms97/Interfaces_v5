 ...
 * Use the [subirFoto.newInstance] factory method to
 * create an instance of this fragment.
 */
class subirFoto : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment subirFoto.
         */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var subir: TextView = view.findViewById(R.id.txtSubir)
        subir.setOnClickListener {
            navCtrl.navigate(R.id.fotoSubida)
        }
        var btnCalendario: ImageView = view.findViewById(R.id.imageView23)
